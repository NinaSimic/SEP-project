...
insert into Merchant(mer_id, name, merchant_id, merchant_password, address, phone, email) values (1,"Naucna Centrala", "1", "1", "a3", "3", "email3@email.com");
insert into Merchant(mer_id, name, merchant_id, merchant_password, address, phone, email) values (2, "H&M", "2", "2", "a4", "4", "email4@email.com");
...
insert into Card(id, pan, active, holder, security_code, validity_date, account_id, card_limit, card_type) values (1, "4062259300840237", true, "Tanja Provci", "337", "2020-11-11 10:10:10", 1, 0, "DEBIT");
insert into Card(id, pan, active, holder, security_code, validity_date, account_id, card_limit, card_type) values (2, "4062255488711215", true, "Djordje Provci", "857", "2020-11-11 10:10:10", 1, 2000, "CREDIT");
insert into Card(id, pan, active, holder, security_code, validity_date, account_id, card_limit, card_type) values (3, "4841878716158815", true, "Aleksandar Arambasic", "641", "2020-11-11 10:10:10", 2, 0, "DEBIT");
